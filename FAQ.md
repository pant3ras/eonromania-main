...
2. Introdu URL-ul: `https://github.com/pant3ras/eonromania` și selectează tipul **Integration**.
...
- ⭐ Oferă un **star** pe [GitHub](https://github.com/pant3ras/eonromania/)
- 🐛 **Raportează probleme** — deschide un [issue](https://github.com/pant3ras/eonromania/issues)
- 🔀 **Contribuie cu cod** — trimite un pull request
- ☕ **Donează** prin [Buy Me a Coffee](https://buymeacoffee.com/pant3ras)
